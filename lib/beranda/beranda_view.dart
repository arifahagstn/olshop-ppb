...
class _BerandaPageState extends State<BerandaPage> {
          ...
          new Row(
            ...
            children: <Widget>[
              ...
              new OutlinedButton(
                onPressed: () {},
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(GojekPalette.grey),
                ),
                child: new Text(
                  "EDIT FAVORITES",
                  style:
  ...
  Future<List<Food>> fetchFood() async {
    ...
    _goFoodFeaturedList.add(new Food(
        title: "Sleep Mask Skinproud", image: "assets/images/food_1.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Hoodie Rabbit", image: "assets/images/food_2.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Bag Ribbon", image: "assets/images/food_3.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Sunscreen Nivea", image: "assets/images/food_4.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Bag Bear", image: "assets/images/food_5.jpg"));
